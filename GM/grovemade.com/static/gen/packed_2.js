    ...
    if ($.support.pjax) {
        ...
        $(document).on('ready', function() {
            ...
            $(document).on('pjax:success', function() {
                ...
                return console.log("pjax:success fading out");
            });
    ...
    root.loader.executeOnKey('product', function() {
        ...
        ProductVariantManager = (function() {
            ...
            ProductVariantManager.prototype._getOptionString = function() {
                var optionValues;
                optionValues = _.map(['option1', 'option2', 'option3', 'option4'], function(option) {
        ...
        $(document).on('click', ".product-notify-trigger", function(ev) {
